...
\033[1;97m--------------------------------------------------
\033[1;97m Author   : AmirAmiri
\033[1;97m My iD   : @Amir_Kandahari
\033[1;97m Chanel  : https://t.me/Best_Hacker00420
\033[1;97m--------------------------------------------------
                     '''
idh = []
...
def tool_login():
    ...
    if username =="amiramiri":
        os.system("clear")
        print logo
        print ("\033[1;92m[] Username : amiramiri (Correct)")
        passwordss = raw_input("\033[1;97m[+] \033[1;97mPassword :\033[1;93m ")
        if passwordss =="amiramiri":
            os.system("clear")
            print logo
            print ("\033[1;92m[] Username : amiramiri (Correct)")
            print ("\033[1;92m[] Password : amiramiri (Correct)")
            print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
...
def login_token():
        ...
        try:
            ...
            time.sleep(1)
            os.system('xdg-open https://www.facebook.com/profile.php?id=100000970514768')
            menu()
